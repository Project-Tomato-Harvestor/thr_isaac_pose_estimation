...
class IsaacROSFoundationPoseLaunchFragment(IsaacROSLaunchFragment):
    ...
    def get_composable_nodes(interface_specs: Dict[str, Any]) -> Dict[str, ComposableNode]:
        ...
        return {
            ...
            #         'mode': 'mono+depth',
            #         'depth_format_string': 'nitros_image_mono16' # 'nitros_image_32FC1', 'nitros_image_mono16'
            #     }],
                
            #     remappings=[
            #         ('image_1', '/d405/color/image_rect_raw'),
            #         ('camera_info_1', '/d405/color/camera_info'),
            #         ('depth_1', '/d405/depth'),
            ...
            'foundationpose_node': ComposableNode(
                ...
                # remappings=[
                #     ('pose_estimation/depth_image', '/d405/depth'),
                #     ('pose_estimation/image', '/d405/color/image_rect_raw'),
                #     ('pose_estimation/camera_info', '/d405/color/camera_info'),
    ...
    foundationpose_container = ComposableNodeContainer(
        ...
        composable_node_descriptions=[
            *IsaacROSFoundationPoseLaunchFragment.get_composable_nodes().values(),
            # IsaacROSFoundationPoseLaunchFragment.get_composable_nodes({})['flange_to_camera_tf_broadcaster'],
        ],
        output='screen'
    )
